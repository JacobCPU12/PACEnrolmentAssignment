...
# Students CRUD
    ...
    path("student/<int:pk>/edit/", views.student_edit_view, name="student_edit"),       # edit
    path("student/<int:pk>/delete/", views.student_delete_view, name="student_delete"), # delete

    path("pac_list/", views.pac_list_view, name="pac_list"),
    path("pac/<int:pk>/edit/", views.pac_edit_view, name="pac_edit"),

    path("pac_form/", views.pac_create_view, name="pac_form"),               # create
    path("pac/<int:pk>/edit/", views.pac_edit_view, name="pac_edit"),        # edit
    path("pac/<int:pk>/delete/", views.pac_delete_view, name="pac_delete"),  # delete
